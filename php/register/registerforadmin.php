<?php
include ('registrationforadmin.php');
?>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <img src="assets/img/bcp logo.png" alt="Logo" class="logo-img">
                    ...
                    <h5 class="card-title text-center pb-0 fs-4">Property Custodian Management System</h5>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    let checkTimer;
    document.querySelectorAll("#fullname, #email, #username").forEach(function (input) {
        input.addEventListener("input", function() {
            clearTimeout(checkTimer);
            checkTimer = setTimeout(() => checkDuplicate(input.id, input.value), 500);
        });
    });
    ...
    function checkDuplicate(field, value) {
        ...
        fetch('assets/validation/check_duplicate.php', {
            method: 'POST',
        ...
        .then(data => {
            ...
            if (data.exists) {
                errorDiv.textContent = `${capitalizeFirstLetter(field)} is already taken.`;
